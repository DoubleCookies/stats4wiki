	...
	public String wikiString(int count) {
		...
		if(difficulty == Difficulty.DEMON) {
			switch(demonDifficulty) {
				case EASY: {diffTemplate+="лёгкий демон"; break;}
				case MEDIUM: {diffTemplate+="средний демон"; break;}
				case HARD: {diffTemplate+="демон"; break;}
				case INSANE: {diffTemplate+="безумный демон"; break;}
				case EXTREME: {diffTemplate+="экстремальный демон"; break;}
			}
		} else {
			switch (difficulty) {
				case EASY: {diffTemplate+="лёгкий"; break;}
				case NORMAL: {diffTemplate+="нормальный"; break;}
				case HARD: {diffTemplate+="сложный"; break;}
				case HARDER: {diffTemplate+="очень сложный"; break;}
				case INSANE: {diffTemplate+="безумный"; break;}
				case AUTO: {diffTemplate+="авто"; break;}
			}
		}
